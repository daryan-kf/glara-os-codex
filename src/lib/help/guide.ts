...
export const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "In Marketing → Campaigns & giveaways, Owner/Admin can prepare an expo campaign. Save a draft with approved dates, eligibility, official rules, privacy wording and prize terms; public intake must be configured separately before opening.",
      "During an expo, filter registrations by day, opt-in, lead priority or contact status. Open the linked Realtor for permitted follow-up. Listing-volume priority never changes a participant’s odds, and a marketing opt-in never overrides an unsubscribe or suppression.",
      "Before closing the campaign, resolve pending identity conflicts. After closing, no entry can be added to the eligible pool. Owner/Admin can run the audited draw, privately verify the selected entrant, and record the required skill-test result before confirming a winner. Disqualification and redraw require recorded reasons.",
      "A confirmed giveaway award is an unapplied service credit. It is not a received payment and does not automatically reduce an invoice. Review its approved terms before any separately authorized commercial application.",
