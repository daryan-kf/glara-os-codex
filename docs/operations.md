...
Supabase-specific release checks are superseded. Provider setup, sender/domain verification, recovery expiry/reuse and production origin/redirect checks retain the status **DEFERRED — REQUIRED BEFORE PRODUCTION**. See the migration report for the complete review boundary; M2 remains stopped.
